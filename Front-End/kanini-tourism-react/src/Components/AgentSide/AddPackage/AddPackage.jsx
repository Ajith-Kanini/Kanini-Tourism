...
export default function AddPackage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      formDataToSend.append("packageName", formData.name);
      formDataToSend.append("destination", formData.email);
      ...
      await axios.post(Variable.PackagesURL.GetAll, formDataToSend, {
        headers: {
